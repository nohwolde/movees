...
function INNERTUBE_HEADER(info) {
  let headers = {
    accept: "*/*",
...
function INNERTUBE_CLIENT(info) {
  let client = {
    gl: info.gl,
    hl: info.hl,
...
export default {URLS, YT_API_VALUES, fs, LOGGER_NAMES, INNERTUBE_HEADER, INNERTUBE_CLIENT};